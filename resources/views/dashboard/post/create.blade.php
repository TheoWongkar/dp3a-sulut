                    ...
                    <div class="space-y-6">
                        ...
                        <div x-data="{ imagePreview: null }">
                            ...
                            <input id="image" type="file" name="image"
                                class="block w-full text-gray-500 mt-1 border border-gray-300 rounded-md shadow-sm focus:border focus:ring-2 focus:ring-[#141652] file:mr-4 file:py-2.5 file:px-4 file:border-0 file:text-sm file:font-semibold file:bg-[#141652] file:text-white hover:file:bg-blue-800 transition ease-in-out duration-200"
