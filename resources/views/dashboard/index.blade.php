<x-app-layout>
    ...
    <section class="bg-white p-6 shadow-lg rounded-lg hover:shadow-xl transition-shadow mb-6">
        ...
        <div class="mt-5 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="col-span-2 bg-white shadow-lg rounded-lg p-6">
                <div class="w-full p-4">
                    <!-- Canvas Container for Report Chart -->
            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
                <div class="w-full p-4">
                    <!-- Canvas Container for Gender Chart -->
                    <div class="relative h-72">
