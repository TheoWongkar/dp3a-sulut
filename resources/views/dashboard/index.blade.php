<x-app-layout>
    ...
    <section class="bg-white p-6 shadow-lg rounded-lg mb-6">
        ...
        <div class="flex items-center mb-4">
            ...
            <!-- Judul Statistik -->
            <h2 class="text-2xl font-semibold">Statistik Laporan</h2>
        </div>

        <!-- Grid untuk Statistik Laporan -->
        ...
        <div class="mt-5 grid grid-cols-1 md:grid-cols-3 gap-6">
            <!-- Report Chart -->
            <div class="col-span-2 bg-white shadow-lg border border-gray-200 rounded-lg p-5">
            ...
            <!-- Gender Chart -->
            <div class="bg-white shadow-lg border border-gray-200 rounded-lg p-5">
                <div class="w-full p-1">
                    <div class="relative h-72">
        ...
        <!-- Regency and District Chart -->
        <div class="mt-5 grid grid-cols-1 lg:grid-cols-2 gap-6">
            <!-- Regency Chart -->
            <div class="bg-white shadow-lg border border-gray-200 rounded-lg p-5">
                <div class="w-full p-1">
                    <h3 class="text-center text-lg font-semibold">Kota/Kabupaten</h3>
                    <div class="relative h-72">
            ...
            <div class="bg-white shadow-lg border border-gray-200 rounded-lg p-5">
                <div class="w-full p-1">
                    <h3 class="text-center text-lg font-semibold">Kecamatan</h3>
                    <div class="relative h-72">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-6 shadow-lg rounded-lg">
            <div class="flex items-center mb-4">
                ...
                <h2 class="text-2xl font-semibold">Statistik Berita</h2>
            </div>
        ...
        <div class="bg-white p-6 shadow-lg rounded-lg">
            <div class="flex items-center mb-4">
                ...
                <h2 class="text-2xl font-semibold">Statistik Karyawan</h2>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div
                    ...
                    <div>
                        <h3 class="text-sm lg:text-xs">Status Nonaktif</h3>
                        <p class="text-3xl font-bold">{{ $inactiveEmployees }}</p>
                    </div>
                </div>
            </div>
            <!-- Card: Karyawan Populer -->
    ...
    <script>
        ...
        new Chart(regencyCtx, {
            type: 'bar',
            data: {
                labels: @json($reportsByRegency->pluck('regency')),
                datasets: [{
                    label: 'Total Laporan',
                    data: @json($reportsByRegency->pluck('total')),
        ...
        new Chart(districtCtx, {
            type: 'bar',
            data: {
                labels: @json($reportsByDistrict->pluck('district')),
                datasets: [{
                    label: 'Total Laporan',
                    data: @json($reportsByDistrict->pluck('total')),
