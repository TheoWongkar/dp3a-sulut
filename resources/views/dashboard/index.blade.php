        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-white shadow-lg rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-4">
                        <!-- Card: Jumlah Berita -->
                        <div
                            class="bg-blue-500 text-gray-100 shadow-lg rounded-lg p-5 flex items-center space-x-4 hover:scale-105 transition duration-300">
                        ...
                        <!-- Card: Status Terbit -->
                        <div
                            class="bg-green-500 text-gray-100 shadow-lg rounded-lg p-5 flex items-center space-x-4 hover:scale-105 transition duration-300">
                        ...
                        <div
                            class="bg-yellow-500 text-gray-100 shadow-lg rounded-lg p-5 flex items-center space-x-4 hover:scale-105 transition duration-300">
                ...
                <div class="bg-white shadow-lg rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-4">
                        ...
                        <div
                            class="bg-red-500 text-gray-100 shadow-lg rounded-lg p-5 flex items-center space-x-4 hover:scale-105 transition duration-300">
                    ...
                    <ul class="mt-4 space-y-2">
                        @forelse ($topPosters as $employee)
                            <li
                                class="flex items-center bg-gray-100 px-4 py-2 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                                <div
            ...
            <div class="bg-white shadow-lg rounded-lg p-6 hover:shadow-xl transition-shadow">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    <!-- Card: Jumlah Laporan -->
                    <div
                        class=" bg-purple-500 text-gray-100 shadow-lg rounded-lg p-5 flex items-center space-x-4 hover:scale-105 transition duration-300">
                        ...
                        <div>
                            <span class="text-sm">Jumlah Laporan</span>
                    ...
                    <div
                        ...
                        <div>
                            <span class="text-sm">Laporan Diterima</span>
                            <p class="text-2xl font-bold">{{ $receivedReports }}</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div>
                            <span class="text-sm">Laporan Diproses</span>
                            <p class="text-2xl font-bold">{{ $processedReports }}</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div>
                            <span class="text-sm">Laporan Selesai</span>
                            <p class="text-2xl font-bold">{{ $completedReports }}</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div>
                            <span class="text-sm">Laporan Dibatalkan</span>
                            <p class="text-2xl font-bold">{{ $canceledReports }}</p>
                        </div>
                    </div>
                </div>
            </div>
