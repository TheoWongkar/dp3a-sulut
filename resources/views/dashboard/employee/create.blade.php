                            ...
                            <div class="space-y-2">
                                ...
                                <div>
                                    ...
                                    <textarea id="address" name="address" rows="4" required
                                        class="mt-1 p-2 w-full border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#141652]">{{ old('address') }}</textarea>
                                    @error('address')
                                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                <!-- Telepon -->
                                <div>
                                    <label for="phone" class="block font-medium text-sm">Telepon</label>
