        ...
        <div class="max-w-3xl mx-auto p-4 bg-white rounded-lg border border-gray-300 shadow">
            ...
            <form action="{{ route('dashboard.post.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <x-forms.input name="title" label="Judul"></x-forms.input>
                    <x-forms.select name="category_id" label="Kategori Berita" :options="$categories->pluck('name', 'id')"></x-forms.select>
