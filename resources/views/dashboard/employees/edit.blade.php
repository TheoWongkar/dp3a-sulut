<x-app-layout>
    ...
    <section class="space-y-2">
        ...
        <div class="p-4 bg-white rounded-lg border border-gray-300 shadow">
            <form action="{{ route('dashboard.employee.update', $employee->nip) }}" method="POST"
                ...
                <div class="grid md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            ...
                            <x-forms.input name="date_of_birth" label="Tanggal Lahir" type="date"
                                :value="old('date_of_birth', $employee->date_of_birth)"></x-forms.input>
                            ...
                            <x-forms.textarea name="place_of_birth" label="Tempat Lahir"
                                :value="old('place_of_birth', $employee->place_of_birth)"></x-forms.textarea>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <x-forms.select name="role" label="Role Pengguna" :options="['Admin', 'Petugas']"
