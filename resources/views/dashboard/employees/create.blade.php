                ...
                <div class="grid md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            ...
                            <x-forms.textarea name="place_of_birth" label="Tempat Lahir"></x-forms.textarea>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <x-forms.select name="role" label="Role Pengguna" :options="['Admin', 'Petugas']"></x-forms.select>
                            <x-forms.input name="password" label="Password" value="dp3asulut"></x-forms.input>
                            <x-forms.input name="password_confirmation" label="Konfirmasi Password"
                                value="dp3asulut"></x-forms.input>
                        </div>
                    </div>
                </div>
