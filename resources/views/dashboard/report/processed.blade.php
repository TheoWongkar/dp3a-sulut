    ...
    <section>
        <div class="bg-white p-6 shadow-lg rounded-lg hover:shadow-xl transition-shadow">
            ...
            <div class="flex flex-col md:flex-row justify-end items-center mb-4 space-y-2 md:space-y-0">
                <form action="{{ route('dashboard.reports.processed') }}" method="GET">
                        ...
                        @forelse ($reports as $report)
                            <tr class="border-t hover:bg-blue-100 transition duration-200">
                                ...
                                <td class="py-4 px-2 text-center">
                                    <span
                                        class="{{ $report->latestStatus->status === 'Diproses' ? 'bg-yellow-500 hover:bg-yellow-600' : '' }}
                                ...
                                <td class="py-1 px-2 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-1">
                                        <a href="{{ route('dashboard.reports.processed-show', $report->ticket_number) }}"
